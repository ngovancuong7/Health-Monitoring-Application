...
public class SignUpActivity extends AppCompatActivity {
    ...
    private AlertDialog alertDialog; // Thêm AlertDialog instance variable
                ...
                userController.signup(
                        emailText, usernameText, passwordText, new UserController.UserControllerCallback() {
                            ...
                            public void onSuccess(String message) {
                                ...
                                alertDialog = new AlertDialog.Builder(SignUpActivity.this) // Lưu AlertDialog instance
                                        .setTitle("Thông báo")
    ...
    protected void onDestroy() {
        super.onDestroy();
        if (alertDialog != null && alertDialog.isShowing()) { // Kiểm tra null và isShowing
